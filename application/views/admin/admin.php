                ...
                <form id='addNewAdminForm' name='addNewAdminForm' role='form'>
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            ...
                            <input type="text" id='firstName' class="form-control glass checkField" placeholder="First Name">
                            <span class="help-block errMsg" id="firstNameErr"></span>
                        </div>
                        <div class="form-group-sm col-sm-6">
                            <label for='lastName' class="control-label">Last Name</label>
                            <input type="text" id='lastName' class="form-control glass checkField" placeholder="Last Name">
                    ...
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            ...
                            <input type="email" id='email' class="form-control glass checkField" placeholder="Email">
                            <span class="help-block errMsg" id="emailErr"></span>
                        </div>
                        <div class="form-group-sm col-sm-6">
                            <label for='role' class="control-label">Role</label>
                            <select class="form-control glass checkField" id='role'>
                    ...
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            ...
                            <input type="tel" id='mobile1' class="form-control glass checkField" placeholder="Phone Number">
                            <span class="help-block errMsg" id="mobile1Err"></span>
                        </div>
                        <div class="form-group-sm col-sm-6">
                            <label for='mobile2' class="control-label">Other Number</label>
                            <input type="tel" id='mobile2' class="form-control glass" placeholder="Other Number (optional)">
                    ...
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            ...
                            <input type="password" class="form-control checkField glass" id="passwordOrig"
                ...
                <form id='editAdminForm' name='editAdminForm' role='form'>
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            ...
                            <input type="text" id='firstNameEdit' class="form-control checkField"
                    ...
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            ...
                            <input type="tel" id='mobile1Edit' class="form-control checkField"
