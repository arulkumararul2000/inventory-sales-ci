            ...
            <div class="row content">
                ...
                <div class="col-sm-2 sidenav hidden-xs mySideNav">
                    ...
                    <ul class="nav nav-pills nav-stacked pointer">
                        <li class="<?= $pageTitle == 'Dashboard' ? 'active' : '' ?> glass">
                            <a href="<?= site_url('dashboard') ?>">
                                <i class="fa fa-home"></i>
                                Dashboard
                            </a>
                        ...
                        <?php if($this->session->admin_role === "Super"):?>
                        <li class="<?= $pageTitle == 'Items' ? 'active' : '' ?> glass">
                            <a href="<?= site_url('items') ?>">
                                <i class="fa fa-archive"></i>
                                Inventory Items
                            </a>
                        ...
                        <li class="<?= $pageTitle == 'Transactions' ? 'active' : '' ?> glass">
                            <a href="<?= site_url('transactions') ?>">
                        ...
                        <li class="<?= $pageTitle == 'Database' ? 'active' : '' ?> glass">
                            <a href="<?= site_url('dbmanagement') ?>">
                                <i class="fa fa-database"></i>
                                Database Management
                            </a>
                        ...
                        <li class="<?= $pageTitle == 'Administrators' ? 'active' : '' ?> glass">
                            <a href="<?= site_url('administrators') ?>">
                                <i class="fa fa-unlock-alt"></i>
                                Admin Management
                            </a>
